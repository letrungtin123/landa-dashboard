...
import { assignCourses } from '@/api/landa-groups';
...
export function AssignCoursesModal({ open, sgId, assignedCourseIds, onOpenChange, onSuccess }: Props) {
  ...
  const mutation = useMutation({
    mutationFn: () => assignCourses(sgId, selected),
    onSuccess: (res) => {
